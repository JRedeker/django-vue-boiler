...
class Category(models.Model):
    ...
    color = models.ForeignKey('app.Color', default=1,on_delete=models.SET_DEFAULT)
    icon = models.ForeignKey('app.Icon', default=1, on_delete=models.SET_DEFAULT)
...
class Item(models.Model):
    ...
    category = models.ForeignKey('app.Category', default=1, on_delete=models.SET_DEFAULT)
